...
public let LFBNavigationBarWhiteBackgroundColor = UIColor.colorWithCustom(red: 249, gree: 250, blue: 253)
...
// MARK: - 常用颜色
public let LFBGlobalBackgroundColor = UIColor.colorWithCustom(red: 239, gree: 239, blue: 239)
public let LFBNavigationYellowColor = UIColor.colorWithCustom(red: 253, gree: 212, blue: 49)
public let LFBTextGreyColol = UIColor.colorWithCustom(red: 130, gree: 130, blue: 130)
public let LFBTextBlackColor = UIColor.colorWithCustom(red: 50, gree: 50, blue: 50)
